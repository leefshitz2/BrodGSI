...
```
sudo bash LinkToGSI.sh sudo bash LinkToGSI.sh "https://cdnorg.d.miui.com/OS3.0.3.0.WBVIDXM/arctic_id_global-images-OS3.0.3.0.WBVIDXM-user-20260522.0000.00-16.0-id-b2351f6de5.tgz" HyperOS
```
